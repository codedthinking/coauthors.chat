...
export function SignupSection() {
  return (
    <>
      <section className="w-full bg-transparent pt-8 sm:pt-16 pb-4">
        <div className="max-w-[1440px] mx-auto px-[12px] sm:px-[52px]">
          <div className="grid lg:grid-cols-2 gap-16 sm:gap-20 lg:gap-48 items-start mb-16 sm:mb-20 lg:mb-[48px] justify-items-center lg:justify-items-start">
      ...
      <section className="coauthors-cta-interested-section w-full mb-[32px]">
        <CTASection />
      </section>
    </>
  );
