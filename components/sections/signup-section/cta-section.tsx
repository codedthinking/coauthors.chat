...
export function CTASection() {
  ...
  return (
    <div className="w-full min-h-[452px] px-4 sm:px-8 lg:px-[135px] py-16 sm:py-20 lg:py-[120px] flex flex-col items-center gap-12 sm:gap-16 lg:gap-[178px] relative isolate">
      {/* Lower gradient: reused for the "Interested? Start talking!" section */}
      <div className="coauthors-cta-lower-bg" aria-hidden="true" />
